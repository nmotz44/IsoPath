...
for (i in 1:length(predator_list)){
  ...
  # create simmr object
  simmr_object = format_simmr_data(data = iso_data, species.column = "Functional_Group", 
                                   d13C.column = "d13C", d15N.column = "d15N", 
